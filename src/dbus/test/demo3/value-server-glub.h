...
G_BEGIN_DECLS
extern
void dbus_glib_marshal_value_object_BOOLEAN__POINTER_POINTER (GClosure     *closure,
                                                              GValue       *return_value,
...
G_BEGIN_DECLS
extern
void dbus_glib_marshal_value_object_BOOLEAN__INT_POINTER (GClosure     *closure,
                                                          GValue       *return_value,
                                                          guint         n_param_values,
                                                          const GValue *param_values,
                                                          gpointer      invocation_hint,
                                                     ...
                                                     gpointer      marshal_data)
{
  ...
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_BOOLEAN__INT_POINTER callback;
  gboolean v_return;
...
G_BEGIN_DECLS
extern
void dbus_glib_marshal_value_object_BOOLEAN__DOUBLE_POINTER (GClosure     *closure,
                                                             GValue       *return_value,
                                                             guint         n_param_values,
                                                             const GValue *param_values,
                                                             gpointer      invocation_hint,
