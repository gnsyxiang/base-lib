 ...
 * 
 *     last modified: 19/07 2019 17:52
 */
...
#define BASE_LIB_UTILS_SRC_TIME_WRAPPER_GB
#include "time_wrapper.h"
#undef BASE_LIB_UTILS_SRC_TIME_WRAPPER_GB
...
{
    // logi(TIME_TAG, "%s->tv_sec : %ld", info, timeval->tv_sec);
    // logi(TIME_TAG, "%s->tv_usec: %ld", info, timeval->tv_usec);
}
